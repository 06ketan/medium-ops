"""Auto-configure MCP hosts to launch medium-ops as a stdio server.

Hosts:
  cursor          ~/.cursor/mcp.json
  claude-desktop  ~/Library/Application Support/Claude/...
  claude-code     shells out to `claude mcp add --transport stdio ...`
  print           prints the JSON snippet only

Always idempotent. Existing config is backed up before write.
"""
...
SERVER_BIN = "medium-ops"


def _server_block(name: str = "medium-ops") -> dict[str, Any]:
...
def install_to_host(*, host: str, name: str = "medium-ops", dry_run: bool = False) -> dict[str, Any]:
